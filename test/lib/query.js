...
describe('Schema',function() {
  ...
  describe('orderByAfter', function() {
    it('should return the 1st 2 teams', function(done) {
      Team.query().orderByAfter('name').limit(2).then(function(result) {
    ...
    it('should return the 2nd 2 teams', function(done) {
      Team.query().orderByAfter('teams.name', 'Team 2').limit(2).then(function(result) {
        var names = _.pluck(result, 'name');
    ...
    it('should return the 2nd to Last 2 teams', function(done) {
      Team.query().orderByAfter('-teams.name', 'Team 4').limit(2).then(function(result) {
        var names = _.pluck(result, 'name');
