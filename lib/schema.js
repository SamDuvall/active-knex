...
_.extend(Schema.prototype, {
  ...
  reload: function(object) {
    ...
    return this.findById(id).then(function(attr) {
  ...
  create: function(data, trx) {
    ...
    return events.triggerBeforeAndAfter('create', data, trx, function(data) {
  ...
  update: function(data, changes, trx) {
    ...
    return events.triggerBeforeAndAfter('update', changes, trx, function(changes) {
      var where = {};
